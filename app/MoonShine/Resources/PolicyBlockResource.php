...
/**
 * @extends ModelResource<PolicyBlock>
 */
class PolicyBlockResource extends ModelResource
{
    protected string $model = PolicyBlock::class;

    protected string $title = 'PolicyBlocks';
