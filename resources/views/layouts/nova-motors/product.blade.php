...
@section('content')
    ...
    <script>
        function createTemplate() {
            ...
            let wrpapper, date, template = document.createElement('div')
            ...
            //wrapper
            wrpapper = document.createElement('div')
            wrpapper.classList.add('pdf-wrapper')

            wrpapper.append(template)
            document.body.append(wrpapper)
