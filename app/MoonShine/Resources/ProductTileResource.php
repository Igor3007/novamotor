...
/**
 * @extends ModelResource<ProductTile>
 */
class ProductTileResource extends ModelResource
{
    protected string $model = ProductTile::class;

    protected string $title = 'ProductTiles';
